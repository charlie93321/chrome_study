(function (f, n, g) {
    var i;
    a:{
        var l = /audio(.min)?.js.*/, m = document.getElementsByTagName("script"), k = 0;
    ...
    l = '      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="$1" width="1" height="1" name="$1" style="position: absolute; left: -1px;">         <param name="movie" value="$2?playerInstance=' + f + '.instances[\'$1\']&datetime=$3">         <param name="allowscriptaccess" value="always">         <embed name="$1" src="$2?playerInstance=' +
        f + '.instances[\'$1\']&datetime=$3" width="1" height="1" allowscriptaccess="always">       </object>';
    ...
    g[f] = {
        instanceCount: 0, instances: {}, flashSource: l, settings: {
            autoplay: !1,
            loop: !1,
            preload: !0,
            imageLocation: m,
            ...
            flashError: function () {
                var a = this.settings.createPlayer, b = h(a.errorMessageClass, this.wrapper),
            ...
            loadError: function () {
                var a = this.settings.createPlayer, b = h(a.errorMessageClass, this.wrapper);
                g[f].helpers.removeClass(this.wrapper,
                    a.loadingClass);
                g[f].helpers.addClass(this.wrapper, a.errorClass);
            ...
            loadStarted: function () {
                var a = this.settings.createPlayer, b = h(a.durationClass, this.wrapper),
            ...
            updatePlayhead: function (a) {
                var b = this.settings.createPlayer, c = h(b.scrubberClass, this.wrapper);
            ...
            for (var c = b || document.getElementsByTagName("audio"), d = [], a = a || {}, e = 0, g = c.length; e < g; e++) d.push(this.newInstance(c[e], a));
            return d
        }, newInstance: function (a, b) {
            var c = this.helpers.clone(this.settings), d = "audiojs" + this.instanceCount, e =
            ...
            c.useFlash && c.hasFlash ? (this.injectFlash(e, d), this.attachFlashEvents(e.wrapper, e)) : c.useFlash && !c.hasFlash && this.settings.flashError.apply(e);
            ...
            d.setAttribute("id", c);
            e.outerHTML && !document.createElement("audio").canPlayType ? (e = this.helpers.cloneHtml5Node(a), d.innerHTML = b.markup, d.appendChild(e), a.outerHTML = d.outerHTML, d = document.getElementById(c)) : (d.appendChild(e), d.innerHTML += b.markup, a.parentNode.replaceChild(d,
                a));
            return d.getElementsByTagName("audio")[0]
        }, attachEvents: function (a, b) {
            if (b.settings.createPlayer) {
                var c = b.settings.createPlayer, d = h(c.playPauseClass, a), e = h(c.scrubberClass, a);
                g[f].events.addListener(d, "click", function () {
                    b.playPause.apply(b)
                });
                g[f].events.addListener(e, "click", function (a) {
                    var a = a.clientX, c = this, d = 0;
                    if (c.offsetParent) {
                        do d += c.offsetLeft; while (c = c.offsetParent)
                    }
                    b.skipTo((a - d) / e.offsetWidth)
                });
                b.settings.useFlash || (g[f].events.trackLoadProgress(b), g[f].events.addListener(b.element,
                    "timeupdate", function () {
            ...
            var c = this.flashSource.replace(/\$1/g, b), c = c.replace(/\$2/g, a.settings.swfLocation),
                c = c.replace(/\$3/g, +new Date + Math.random()), d = a.wrapper.innerHTML,
            ...
            merge: function (a, b) {
                ...
                d && (f.setAttribute("type", "text/css"), f.setAttribute("title", "audiojs"), f.styleSheet ? f.styleSheet.cssText = c + e : f.appendChild(document.createTextNode(c + e)), g ? d.insertBefore(f, g) : d.appendChild(styleElement))
            ...
            memoryLeaking: !1, listeners: [], addListener: function (a, b, c) {
                a.addEventListener ? a.addEventListener(b, c, !1) : a.attachEvent && (this.listeners.push(a), this.memoryLeaking || (window.attachEvent("onunload", function () {
                    if (this.listeners) for (var a = 0, b = this.listeners.length; a < b; a++) g[f].events.purge(this.listeners[a])
                }), this.memoryLeaking = !0), a.attachEvent("on" + b, function () {
                    c.call(a,
                        window.event)
                }))
                ...
                if (a.settings.preload) {
                    ...
                    b = setInterval(function () {
                        ...
                        1 < a.element.readyState && (a.settings.autoplay && a.play.apply(a), clearInterval(b), c = setInterval(function () {
                ...
                if (b) for (c = 0; c < b.length; c += 1) "function" === typeof a[b[c].name] &&
                (a[b[c].name] = null);
                if (b = a.childNodes) for (c = 0; c < b.length; c += 1) purge(a.childNodes[c])
            }, ready: function (a) {
                var b = window, c = !1, d = !0, e = b.document, f = e.documentElement,
                    ...
                    j = function (d) {
                        if (!("readystatechange" == d.type && "complete" != e.readyState) && (("load" == d.type ? b : e)[h](i + d.type, j, !1), !c && (c = !0))) a.call(b, d.type || d)
                    }, k = function () {
                        try {
                            f.doScroll("left")
                        } catch (a) {
    ...
    g[n].prototype = {
        ...
        loadStarted: function () {
            ...
            this.settings.preload || (this.settings.preload = !0, this.element.setAttribute("preload", "auto"), g[f].events.trackLoadProgress(this));
            this.playing = !0;
            this.element.play();
